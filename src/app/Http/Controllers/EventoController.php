...
// Agregar la clase Validator para validar los datos de
...
/**
* Almacenar un recurso recién creado en el

*/
public function store(Request $request)
{
// Validar que la petición contenga todos los datos
...
// Si el recurso no se pudo recuperar, retornar un
...
/**
* Actualizar el recurso especificado en el
